    ...
    <div id="footerCon" className="footerCon">
     ...
     <div className="footer row">
      <h6 className="socialHeader">Connect with us</h6>
       ...
       <a className="ig-link column" href="https://www.instagram.com/majesticprodigy?igsh=MTJnZmdmYnVxOWpzdQ==">
      ...
      <div className="copyright">&copy; 2024<span className="purple"> MajesticPips</span> All rights reserved.</div>
    </div>
  )
}
