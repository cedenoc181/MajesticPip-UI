...
function Mission() {
  ...
  return (
    ...
    <h2 className="missionTitle" data-aos="fade-up" data-aos-duration="1000">Our <span className="purple">Mission</span></h2>
   ...
   <h3 className="missionTitle2" data-aos="fade-left" data-aos-duration="1000"><span className="purple"> Why</span> us?</h3>
   ...
   and alerts, ensuring you're always informed and ready to act on the latest opportunities.
    ...
    <h4 className="missionTitle3" data-aos="fade-right" data-aos-duration="1000"> Our <span className="purple">Ultimate</span> Goal!</h4>
